...
let array=[];
useEffect(() => {
  dispatch(siteData({page:'booking'}));
},[]);
  useEffect(() => {
alert("hello");
    ...
    //  alert(submitStatus+' = '+reducer3.applicant_id);
                   ...
                   <div class="timeslots-top date-section" style={{height:'115px'}}>
                       ...
                       <div class="row date-sec">
                           ...
                           <div class="col-md-9" style={{paddingLeft:'0px'}}>
                               ...
                               <a  class="btn-time btn-change" style={{textDecoration: 'none',cursor: 'pointer',color:'#646663', textAlign: 'left'}}>Change Date </a>
...
<div class="col-md-12" onClick={()=>{setShow1(true);setBookingFacility()}}>
    ...
    <a  class="btn-book btn-process btn-check "  data-dismiss="modal" style={{textDecoration: 'none',color:'#ffffff'}}>Request Booking</a>
