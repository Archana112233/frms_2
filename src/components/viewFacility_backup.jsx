...
useEffect(() => {
  ...
  dispatch(siteData({page:'viewfacility'}));
...
<div class="col-md-8">
                ...
                <div class="detail-page-header">					
                    ...
                    <div class="row" style={{marginTop:'20px'}}>
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" style={{fontFamily: 'Heebo-Bold', textAlign: 'left'}}>Amenities:</div>
                    ...
                    <div class="row">    
                         ...
                         <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" style={{fontFamily: 'Heebo-Bold', textAlign: 'left'}}>Rates:</div>   
